...
/* DIALOG*/
var a_dialog=app.dialogs.add({name:"3D-Heft",canCancel:!1}),min_width_left=50,min_width_right=250,heft1="11Freunde",heft2="noSports",heft3="Chronik",heft4="Buch-innen_17x24",heft5="Buch-innen_21x28";with(a_dialog)with(dialogColumns.add())with(borderPanels.add()){with(dialogColumns.add())staticTexts.add({staticLabel:"Heft:",minWidth:min_width_left});with(dialogColumns.add()){var heft=radiobuttonGroups.add();with(heft)radiobuttonControls.add({staticLabel:heft1,checkedState:!0,minWidth:min_width_right}),radiobuttonControls.add({staticLabel:heft2,checkedState:!1,minWidth:min_width_right}),radiobuttonControls.add({staticLabel:heft3,checkedState:!1,minWidth:min_width_right}),radiobuttonControls.add({staticLabel:heft4,checkedState:!1,minWidth:min_width_right}),radiobuttonControls.add({staticLabel:heft5,checkedState:!1,minWidth:min_width_right})}}if(0==a_dialog.show())a_dialog.destroy();else if(0==heft.selectedButton)var heft=heft1,master=new File("~/Arbeit/11Freunde/3D/11F_3D-Heft/Master/3D__11F-innen__MASTER_v5_flach.tif");
//~             var master = new File("/Volumes/grafik/Fach_Grafik/11F_3D-Heft/Master/3D__11F-innen__MASTER.tif");
else if(1==heft.selectedButton)var heft=heft2,master=new File("~/Arbeit/11Freunde/3D/11F_3D-Heft/Master/3D__noSports-innen__MASTER.tif");else if(2==heft.selectedButton)var heft=heft3,master=new File("~/Arbeit/11Freunde/3D/11F_3D-Heft/Master/3D__Chronik-innen__MASTER_flach.tif");else if(3==heft.selectedButton)var heft=heft4,master=new File("~/Arbeit/11Freunde/3D/11F_3D-Heft/Master/3D__Buch-innen_17x24__MASTER.psd");else if(4==heft.selectedButton)var heft=heft5,master=new File("~/Arbeit/11Freunde/3D/11F_3D-Heft/Master/3D__Buch-innen_21x28__MASTER.psd");
...
/////////////////////////////////////////////////// PS
function runPS(e,t,i,n,r,a){function o(e){return app.charIDToTypeID(e)}function s(){var e=new ActionDescriptor,t=new ActionReference;t.putProperty(charIDToTypeID("HstS"),charIDToTypeID("CrnH")),e.putReference(charIDToTypeID("null"),t),executeAction(charIDToTypeID("Dlt "),e,DialogModes.NO)}function l(e,t){
/*choose Layer*/
var i=new ActionDescriptor,n=new ActionReference;n.putName(o("Lyr "),e),i.putReference(o("null"),n),i.putBoolean(o("MkVs"),!1),executeAction(o("slct"),i,DialogModes.NO);
/* ======================================================= */
var r=stringIDToTypeID("placedLayerEditContents"),a=new ActionDescriptor;executeAction(r,a,DialogModes.NO);
/* ======================================================= */
