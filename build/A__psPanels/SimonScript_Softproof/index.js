...
/**
	 ...
	 */function c(e,t,n){for(var r=e.tagName,a=null,i=e.length;i--;){var o=e[i],s=o.qName,c=o.value;if((p=s.indexOf(":"))>0)var u=o.prefix=s.slice(0,p),l=s.slice(p+1),d="xmlns"===u&&l;else l=s,u=null,d="xmlns"===s&&"";
...
"xml"===u&&(o.uri="http://www.w3.org/XML/1998/namespace"),"xmlns"!==u&&(o.uri=n[u||""]))}var p;(p=r.indexOf(":"))>0?(u=e.prefix=r.slice(0,p),l=e.localName=r.slice(p+1)):(u=null,//important!!
l=e.localName=r);
...
//parseStack.push(el);
return e.currentNSMap=n,e.localNSMap=a,!0;if(t.endElement(h,l,r),a)for(u in a)t.endPrefixMapping(u)}function u(e,t,n,r,a){if(/^(?:script|textarea)$/i.test(n)){var i=e.indexOf("</"+n+">",t),o=e.substring(t+1,i);if(/[&<]/.test(o))return/^script$/i.test(n)?(
//if(!/\]\]>/.test(text)){
...
if(t>x){var n=e.substring(x,t).replace(/&#?\w+;/g,f);y&&N(x),r.characters(n,0,t-x),x=t}}function N(t,n){for(;t>=w&&(n=E.exec(e));)v=n.index,w=v+n[0].length,y.lineNumber++;y.columnNumber=t-v+1}var v=0,w=0,E=/.*(?:\r\n?|\n)|.*$/g,y=r.locator,b=[{currentNSMap:t}],T={},x=0;for(;;){try{var D=e.indexOf("<",x);if(D<0){if(!e.substr(x).match(/^\s*$/)){var C=r.doc,S=C.createTextNode(e.substr(x));C.appendChild(S),r.currentElement=S}return}switch(D>x&&g(D),e.charAt(D+1)){case"/":var _=e.indexOf(">",D+3),A=e.substring(D+2,_),I=b.pop();_<0?(A=e.substring(D+2).replace(/[\s<].*/,""),i.error("end tag name: "+A+" is not complete:"+I.tagName),_=D+1+A.length):A.match(/\s</)&&(A=A.replace(/[\s<].*/,""),i.error("end tag name: "+A+" maybe not complete"),_=D+1+A.length);var O=I.localNSMap,R=I.tagName==A;if(R||I.tagName&&I.tagName.toLowerCase()==A.toLowerCase()){if(r.endElement(I.uri,I.localName,A),O)for(var B in O)r.endPrefixMapping(B);R||i.fatalError("end tag name: "+A+" is not match the current start tagName:"+I.tagName)}else b.push(I);_++;break;
// end elment
case"?":// <?...?>
y&&N(D),_=p(e,D,r);break;case"!":// <!doctype,<![CDATA,<!--
y&&N(D),_=d(e,D,r,i);break;default:y&&N(D);var M=new h,k=b[b.length-1].currentNSMap,L=(_=s(e,D,M,k,f,i),M.length);if(!M.closed&&l(e,_,M.tagName,T)&&(M.closed=!0,n.nbsp||i.warning("unclosed xml attribute")),y&&L){
//try{//attribute position fixed
for(var q=o(y,{}),P=0;P<L;P++){var F=M[P];N(F.offset),F.locator=o(y,{})}r.locator=q,c(M,r,k)&&b.push(M),r.locator=y}else c(M,r,k)&&b.push(M);"http://www.w3.org/1999/xhtml"!==M.uri||M.closed?_++:_=u(e,_,M.tagName,f,r)}}catch(e){if(e instanceof a)throw e;i.error("element parse error: "+e),_=-1}_>x?x=_:
//TODO: 这里有可能sax回退，有位置错误风险
g(Math.max(D,x)+1)}}(e,t,n,r,this.errorHandler),r.endDocument()}},h.prototype={setTagName:function(e){if(!r.test(e))throw new Error("invalid tagName:"+e);this.tagName=e},addValue:function(e,t,n){if(!r.test(e))throw new Error("invalid attribute:"+e);this.attributeNames[e]=this.length,this[this.length++]={qName:e,value:t,offset:n}},length:0,getLocalName:function(e){return this[e].localName},getLocator:function(e){return this[e].locator},getQName:function(e){return this[e].qName},getURI:function(e){return this[e].uri},getValue:function(e){return this[e].value}
...
/**
	 ...
	 */
function q(){}function P(e,t){this._node=e,this._refresh=t,F(this)}function F(e){var t=e._node._inc||e._node.ownerDocument._inc;if(e._inc!=t){var n=e._refresh(e._node);
...
/**
	 ...
	 */
function U(){}function V(e,t){for(var n=e.length;n--;)if(e[n]===t)return n}function z(e,t,n,r){if(r?t[V(t,r)]=n:t[t.length++]=n,e){n.ownerElement=e;var a=e.ownerDocument;a&&(r&&G(a,e,r),function(e,t,n){e&&e._inc++,"http://www.w3.org/2000/xmlns/"==n.namespaceURI&&(
//update namespace
t._nsMap[n.prefix?n.localName:""]=n.value)}(a,e,n))}}function $(e,t,n){
//console.log('remove attr:'+attr)
var r=V(t,n);if(!(r>=0))throw L(M,new Error(e.tagName+"@"+n));for(var a=t.length-1;r<a;)t[r]=t[++r];if(t.length=a,e){var i=e.ownerDocument;i&&(G(i,e,n),n.ownerElement=null)}}
/**
...
/**
	 ...
	 */function Q(e,t,n){var r=t.parentNode;if(r&&r.removeChild(t),t.nodeType===A){var a=t.firstChild;if(null==a)return t;var i=t.lastChild}else a=i=t;var o=n?n.previousSibling:e.lastChild;a.previousSibling=o,i.nextSibling=n,o?o.nextSibling=a:e.firstChild=a,null==n?e.lastChild=i:n.previousSibling=i;do{a.parentNode=e}while(a!==i&&(a=a.nextSibling));return Z(e.ownerDocument||e,e),
//console.log(parentNode.lastChild.nextSibling == null)
t.nodeType==A&&(t.firstChild=t.lastChild=null),t}function J(){this._nsMap={}}function ee(){}function te(){}function ne(){}function re(){}function ae(){}function ie(){}function oe(){}function se(){}function ce(){}function ue(){}function le(){}function me(){}function de(e,t){var n=[],r=9==this.nodeType&&this.documentElement||this,a=r.prefix,i=r.namespaceURI;if(i&&null==a&&null==(a=r.lookupPrefix(i)))
//isHTML = true;
var o=[{namespace:i,prefix:null}];
//console.log('###',this.nodeType,uri,prefix,buf.join(''))
return he(this,n,e,t,o),n.join("")}function pe(e,t,n){var r=e.prefix||"",a=e.namespaceURI;if(!r&&!a)return!1;if("xml"===r&&"http://www.w3.org/XML/1998/namespace"===a||"http://www.w3.org/2000/xmlns/"==a)return!1;
...
return!0}function he(e,t,n,r,a){if(r){if(!(e=r(e)))return;
//buf.sort.apply(attrs, attributeSorter);
if("string"==typeof e)return void t.push(e)}switch(e.nodeType){case w:a||(a=[]),a.length;var i=e.attributes,o=i.length,s=e.firstChild,c=e.tagName;n="http://www.w3.org/1999/xhtml"===e.namespaceURI||n,t.push("<",c);for(var u=0;u<o;u++){"xmlns"==(l=i.item(u)).prefix?a.push({prefix:l.localName,namespace:l.value}):"xmlns"==l.nodeName&&a.push({prefix:"",namespace:l.value})}for(u=0;u<o;u++){var l;if(pe(l=i.item(u),0,a)){var m=l.prefix||"",d=l.namespaceURI,p=m?" xmlns:"+m:" xmlns";t.push(p,'="',d,'"'),a.push({prefix:m,namespace:d})}he(l,t,n,r,a)}
// add namespace for current node		
if(pe(e,0,a)){m=e.prefix||"";if(d=e.namespaceURI){
// Avoid empty namespace value like xmlns:ds=""
// Empty namespace URL will we produce an invalid XML document
p=m?" xmlns:"+m:" xmlns";t.push(p,'="',d,'"'),a.push({prefix:m,namespace:d})}}if(s||n&&!/^(?:meta|link|img|br|hr|input)$/i.test(c)){
//if is cdata child node
if(t.push(">"),n&&/^script$/i.test(c))for(;s;)s.data?t.push(s.data):he(s,t,n,r,a),s=s.nextSibling;else for(;s;)he(s,t,n,r,a),s=s.nextSibling;t.push("</",c,">")}else t.push("/>");
// remove added visible namespaces
//visibleNamespaces.length = startVisibleNamespaces;
return;case S:case A:for(s=e.firstChild;s;)he(s,t,n,r,a),s=s.nextSibling;return;case E:
/**
...
/**
			 ...
			 */
return t.push(e.data.replace(/[<&]/g,H).replace(/]]>/g,"]]&gt;"));case b:return t.push("<![CDATA[",e.data,"]]>");case C:return t.push("\x3c!--",e.data,"--\x3e");case _:var h=e.publicId,f=e.systemId;if(t.push("<!DOCTYPE ",e.name),h)t.push(" PUBLIC ",h),f&&"."!=f&&t.push(" ",f),t.push(">");else if(f&&"."!=f)t.push(" SYSTEM ",f,">");else{var g=e.internalSubset;g&&t.push(" [",g,"]"),t.push(">")}return;case D:return t.push("<?",e.target," ",e.data,"?>");case T:return t.push("&",e.nodeName,";");
//case ENTITY_NODE:
//case NOTATION_NODE:
default:t.push("??",e.nodeName)}}function fe(e,t,n){var r;switch(t.nodeType){case w:(r=t.cloneNode(!1)).ownerDocument=e;
//var attrs = node2.attributes;
//var len = attrs.length;
//for(var i=0;i<len;i++){
//node2.setAttributeNodeNS(importNode(doc,attrs.item(i),deep));
//}
case A:break;case E:n=!0;
...
function ge(e,t,n){var r=new t.constructor;for(var a in t){var i=t[a];"object"!=typeof i&&i!=r[a]&&(r[a]=i)}switch(t.childNodes&&(r.childNodes=new q),r.ownerDocument=e,r.nodeType){case w:var o=t.attributes,s=r.attributes=new U,c=o.length;s._ownerElement=r;for(var u=0;u<c;u++)r.setAttributeNode(ge(e,o.item(u),!0));break;case E:n=!0}if(n)for(var l=t.firstChild;l;)r.appendChild(ge(e,l,n)),l=l.nextSibling;return r}function Ne(e,t,n){e[t]=n}
//do dynamic
O.INVALID_STATE_ERR=(R[11]="Invalid state",11),O.SYNTAX_ERR=(R[12]="Syntax error",12),O.INVALID_MODIFICATION_ERR=(R[13]="Invalid modification",13),O.NAMESPACE_ERR=(R[14]="Invalid namespace",14),O.INVALID_ACCESS_ERR=(R[15]="Invalid access",15),L.prototype=Error.prototype,g(O,L),q.prototype={
/**
...
/**
		 ...
		 */
item:function(e){return this[e]||null},toString:function(e,t){for(var n=[],r=0;r<this.length;r++)he(this[r],n,e,t);return n.join("")}},P.prototype.item=function(e){return F(this),this[e]},N(P,q),U.prototype={length:0,item:q.prototype.item,getNamedItem:function(e){for(
...
var r=new W;if(r.implementation=this,r.childNodes=new q,r.doctype=n,n&&r.appendChild(n),t){var a=r.createElementNS(e,t);r.appendChild(a)}return r},
// Introduced in DOM Level 2:
...
//console.dir(map)
if(n)for(var r in n)if(n[r]==e)return r;t=t.nodeType==E?t.ownerDocument:t.parentNode}return null},
// Introduced in DOM Level 3:
lookupNamespaceURI:function(e){for(var t=this;t;){var n=t._nsMap;
//console.dir(map)
if(n&&e in n)return n[e];t=t.nodeType==E?t.ownerDocument:t.parentNode}return null},
// Introduced in DOM Level 3:
...
if(e.nodeType==A){for(var n=e.firstChild;n;){var r=n.nextSibling;this.insertBefore(n,t),n=r}return e}return null==this.documentElement&&e.nodeType==w&&(this.documentElement=e),Q(this,e,t),e.ownerDocument=this,e},removeChild:function(e){return this.documentElement==e&&(this.documentElement=null),K(this,e)},
// Introduced in DOM Level 2:
importNode:function(e,t){return fe(this,e,t)},
// Introduced in DOM Level 2:
getElementById:function(e){var t=null;return Y(this.documentElement,(function(n){if(n.nodeType==w&&n.getAttribute("id")==e)return t=n,!0})),t},getElementsByClassName:function(e){var t=new RegExp("(^|\\s)"+e+"(\\s|$)");return new P(this,(function(e){var n=[];return Y(e.documentElement,(function(r){r!==e&&r.nodeType==w&&t.test(r.getAttribute("class"))&&n.push(r)})),n}))},
//document factory method:
createElement:function(e){var t=new J;return t.ownerDocument=this,t.nodeName=e,t.tagName=e,t.childNodes=new q,(t.attributes=new U)._ownerElement=t,t},createDocumentFragment:function(){var e=new ue;return e.ownerDocument=this,e.childNodes=new q,e},createTextNode:function(e){var t=new ne;return t.ownerDocument=this,t.appendData(e),t},createComment:function(e){var t=new re;return t.ownerDocument=this,t.appendData(e),t},createCDATASection:function(e){var t=new ae;return t.ownerDocument=this,t.appendData(e),t},createProcessingInstruction:function(e,t){var n=new le;return n.ownerDocument=this,n.tagName=n.target=e,n.nodeValue=n.data=t,n},createAttribute:function(e){var t=new ee;return t.ownerDocument=this,t.name=e,t.nodeName=e,t.localName=e,t.specified=!0,t},createEntityReference:function(e){var t=new ce;return t.ownerDocument=this,t.nodeName=e,t},
// Introduced in DOM Level 2:
createElementNS:function(e,t){var n=new J,r=t.split(":"),a=n.attributes=new U;return n.childNodes=new q,n.ownerDocument=this,n.nodeName=t,n.tagName=t,n.namespaceURI=e,2==r.length?(n.prefix=r[0],n.localName=r[1]):
//el.prefix = null;
...
//el.prefix = null;
n.localName=t,n}},N(W,j),J.prototype={nodeType:w,hasAttribute:function(e){return null!=this.getAttributeNode(e)},getAttribute:function(e){var t=this.getAttributeNode(e);return t&&t.value||""},getAttributeNode:function(e){return this.attributes.getNamedItem(e)},setAttribute:function(e,t){var n=this.ownerDocument.createAttribute(e);n.value=n.nodeValue=""+t,this.setAttributeNode(n)},removeAttribute:function(e){var t=this.getAttributeNode(e);t&&this.removeAttributeNode(t)},
//four real opeartion method
appendChild:function(e){return e.nodeType===A?this.insertBefore(e,null):function(e,t){var n=t.parentNode;if(n){var r=e.lastChild;n.removeChild(t),r=e.lastChild}return r=e.lastChild,t.parentNode=e,t.previousSibling=r,t.nextSibling=null,r?r.nextSibling=t:e.firstChild=t,e.lastChild=t,Z(e.ownerDocument,e,t),t;
...
removeAttributeNS:function(e,t){var n=this.getAttributeNodeNS(e,t);n&&this.removeAttributeNode(n)},hasAttributeNS:function(e,t){return null!=this.getAttributeNodeNS(e,t)},getAttributeNS:function(e,t){var n=this.getAttributeNodeNS(e,t);return n&&n.value||""},setAttributeNS:function(e,t,n){var r=this.ownerDocument.createAttributeNS(e,t);r.value=r.nodeValue=""+n,this.setAttributeNode(r)},getAttributeNodeNS:function(e,t){return this.attributes.getNamedItemNS(e,t)},getElementsByTagName:function(e){return new P(this,(function(t){var n=[];return Y(t,(function(r){r===t||r.nodeType!=w||"*"!==e&&r.tagName!=e||n.push(r)})),n}))},getElementsByTagNameNS:function(e,t){return new P(this,(function(n){var r=[];return Y(n,(function(a){a===n||a.nodeType!==w||"*"!==e&&a.namespaceURI!==e||"*"!==t&&a.localName!=t||r.push(a)})),r}))}},W.prototype.getElementsByTagName=J.prototype.getElementsByTagName,W.prototype.getElementsByTagNameNS=J.prototype.getElementsByTagNameNS,N(J,j),ee.prototype.nodeType=E,N(ee,j),te.prototype={data:"",substringData:function(e,t){return this.data.substring(e,e+t)},appendData:function(e){e=this.data+e,this.nodeValue=this.data=e,this.length=e.length},insertData:function(e,t){this.replaceData(e,0,t)},appendChild:function(e){throw new Error(R[B])},deleteData:function(e,t){this.replaceData(e,t,"")},replaceData:function(e,t,n){n=this.data.substring(0,e)+n+this.data.substring(e+t),this.nodeValue=this.data=n,this.length=n.length}},N(te,j),ne.prototype={nodeName:"#text",nodeType:y,splitText:function(e){var t=this.data,n=t.substring(e);t=t.substring(0,e),this.data=this.nodeValue=t,this.length=t.length;var r=this.ownerDocument.createTextNode(n);return this.parentNode&&this.parentNode.insertBefore(r,this.nextSibling),r}},N(ne,te),re.prototype={nodeName:"#comment",nodeType:C},N(re,te),ae.prototype={nodeName:"#cdata-section",nodeType:b},N(ae,te),ie.prototype.nodeType=_,N(ie,j),oe.prototype.nodeType=I,N(oe,j),se.prototype.nodeType=x,N(se,j),ce.prototype.nodeType=T,N(ce,j),ue.prototype.nodeName="#document-fragment",ue.prototype.nodeType=A,N(ue,j),le.prototype.nodeType=D,N(le,j),me.prototype.serializeToString=function(e,t,n){return de.call(e,t,n)},j.prototype.toString=de;try{if(Object.defineProperty){function ve(e){switch(e.nodeType){case w:case A:var t=[];for(e=e.firstChild;e;)7!==e.nodeType&&8!==e.nodeType&&t.push(ve(e)),e=e.nextSibling;return t.join("");default:return e.nodeValue}}Object.defineProperty(P.prototype,"length",{get:function(){return F(this),this.$$length}}),Object.defineProperty(j.prototype,"textContent",{get:function(){return ve(this)},set:function(e){switch(this.nodeType){case w:case A:for(;this.firstChild;)this.removeChild(this.firstChild);(e||String(e))&&this.appendChild(this.ownerDocument.createTextNode(e));break;default:
//TODO:
...
var we,Ee={Node:j,DOMException:L,DOMImplementation:X,XMLSerializer:me},ye=(function(t,n){function r(e){this.options=e||{locator:{}}}
//console.log('#\n\n\n\n\n\n\n####')
/**
...
//if(typeof require == 'function'){
r.prototype.parseFromString=function(t,n){var r=this.options,i=new u,s=r.domBuilder||new a,c=r.errorHandler,l=r.locator,m=r.xmlns||{},d=/\/x?html?$/.test(n),p=d?e.entityMap:{lt:"<",gt:">",amp:"&",quot:'"',apos:"'"};return l&&s.setDocumentLocator(l),i.errorHandler=function(e,t,n){if(!e){if(t instanceof a)return t;e=t}var r={},i=e instanceof Function;function s(t){var a=e[t];!a&&i&&(a=2==e.length?function(n){e(t,n)}:e),r[t]=a&&function(e){a("[xmldom "+t+"]\t"+e+o(n))}||function(){}}return n=n||{},s("warning"),s("error"),s("fatalError"),r}(c,s,l),i.domBuilder=r.domBuilder||s,d&&(m[""]="http://www.w3.org/1999/xhtml"),m.xml=m.xml||"http://www.w3.org/XML/1998/namespace",t&&"string"==typeof t?i.parse(t,m,p):i.errorHandler.error("invalid doc source"),s.doc},a.prototype={startDocument:function(){this.doc=(new m).createDocument(null,null,null),this.locator&&(this.doc.documentURI=this.locator.systemId)},startElement:function(e,t,n,r){var a=this.doc,o=a.createElementNS(e,n||t),s=r.length;c(this,o),this.currentElement=o,this.locator&&i(this.locator,o);for(var u=0;u<s;u++){e=r.getURI(u);var l=r.getValue(u),m=(n=r.getQName(u),a.createAttributeNS(e,n));this.locator&&i(r.getLocator(u),m),m.value=m.nodeValue=l,o.setAttributeNode(m)}},endElement:function(e,t,n){var r=this.currentElement;r.tagName,this.currentElement=r.parentNode},startPrefixMapping:function(e,t){},endPrefixMapping:function(e){},processingInstruction:function(e,t){var n=this.doc.createProcessingInstruction(e,t);this.locator&&i(this.locator,n),c(this,n)},ignorableWhitespace:function(e,t,n){},characters:function(e,t,n){
//console.log(chars)
...
/**
		 ...
		 */
warning:function(e){console.warn("[xmldom warning]\t"+e,o(this.locator))},error:function(e){console.error("[xmldom error]\t"+e,o(this.locator))},fatalError:function(e){throw new l(e,this.locator)}},"endDTD,startEntity,endEntity,attributeDecl,elementDecl,externalEntityDecl,internalEntityDecl,resolveEntity,getExternalSubset,notationDecl,unparsedEntityDecl".replace(/\w+/g,(function(e){a.prototype[e]=function(){return null}}));var u=f.XMLReader,l=f.ParseError,m=n.DOMImplementation=Ee.DOMImplementation;n.XMLSerializer=Ee.XMLSerializer,n.DOMParser=r,n.__DOMHandler=a}(we={exports:{}},we.exports),we.exports);const be="proofsetup",Te="proof_profil",xe="proof_intent",De="proof_tk",Ce="proof_group",Se=document.getElementById("proofinfo");
// fix bug: loose focus
function _e(e){require("photoshop").core.performMenuCommand({commandID:e,kcanDispatchWhileModal:!0,_isCommand:!1})}
// menuCommand(2982);menuCommand(2986);menuCommand(2986);
// attach event listeners for tabs
Array.from(document.querySelectorAll(".sp-tab")).forEach((e=>{e.onclick=()=>{localStorage.setItem("currentTab",e.getAttribute("id")),Array.from(document.querySelectorAll(".sp-tab")).forEach((t=>{t.getAttribute("id")===e.getAttribute("id")?t.classList.add("selected"):t.classList.remove("selected")})),Array.from(document.querySelectorAll(".sp-tab-page")).forEach((t=>{t.getAttribute("id").startsWith(e.getAttribute("id"))?t.classList.add("visible"):t.classList.remove("visible")}))}}));const Ae=document.querySelectorAll("sp-radio:not(.noSoftproof)"),Ie=document.querySelectorAll("sp-radio.noSoftproof");for(const e of Ae)e.addEventListener("click",(async function(e){if(0!=require("photoshop").app.documents.length){
//   showAlert("Please open at least one document.");
//   return;
// }
// else {
var t,n;for(t=0;t<Ae.length;t++)// uncheck all other radios
Ae[t].checked=!1;for(this.checked=!0,n=0;n<Ie.length;n++)// uncheck all noSoftproof-Radios
Ie[n].checked=!1;
...
let e=this.getAttribute("data-proofProfil"),r=this.getAttribute("data-proofIntent"),a=this.getAttribute("data-proofTK"),i="true"===a,o=this.getAttribute("data-proofGroup");await Oe(e,r,i),await ke(e,r,a,o),// loadScript("[panel] softproof2meta");
await qe(),
...
// }
_e(2982),_e(2986),_e(2986)}}));for(const e of Ie)e.addEventListener("click",(async function(){0!=require("photoshop").app.documents.length&&(
// console.log(noSoftproof);
await Re(),await Le(),await qe(),
...
// }
_e(2982),_e(2986),_e(2986))}));async function Oe(e,t,n){const r=require("photoshop").action.batchPlay;await r([{_obj:"proofSetup",profile:e,intent:{_enum:"intent",_value:t},mapBlack:n,_options:{dialogOptions:"dontDisplay"}}],{synchronousExecution:!1,modalBehavior:"fail"})}async function Re(){const e=require("photoshop").action.batchPlay;await e([{_obj:"select",_target:[{_ref:"menuItemClass",_enum:"menuItemType",_value:"toggleProofColors"}],_options:{dialogOptions:"dontDisplay"}}],{synchronousExecution:!1,modalBehavior:"fail"})}async function Be(e){const t=require("photoshop").action.batchPlay;await t([{_obj:"set",_target:[{_ref:"property",_property:"XMPMetadataAsUTF8"},{_ref:"document",_enum:"ordinal",_value:"targetEnum"}],to:{_obj:"document",XMPMetadataAsUTF8:e}}],{synchronousExecution:!0,modalBehavior:"fail"})}async function Me(){const e=require("photoshop").action.batchPlay;return(await e([{_obj:"get",_target:[{_property:"XMPMetadataAsUTF8"},{_ref:"document",_enum:"ordinal",_value:"targetEnum"}]}],{synchronousExecution:!1,modalBehavior:"fail"}))[0].XMPMetadataAsUTF8}
// setSoftproof(dataProofProfil, dataProofIntent, dataproofTK)
async function ke(e,t,n,r){const a=await Me(),i=await(new ye.DOMParser).parseFromString(a,"text/xml");i.documentElement.getElementsByTagName("rdf:Description")[0].hasAttribute("xmlns:"+be)||i.documentElement.getElementsByTagName("rdf:Description")[0].setAttribute("xmlns:"+be,"http://ns.simonadrian.de/proofsetup/1.0");var o=i.documentElement;if(0!=i.getElementsByTagName(be+":"+Te).length){var s=i.getElementsByTagName(be+":"+Te)[0];(c=i.createElement(be+":"+Te)).textContent=e,o.replaceChild(c,s)}else{var c;(c=i.createElement(be+":"+Te)).textContent=e,i.getElementsByTagName("rdf:Description")[0].appendChild(c)}if(0!=i.getElementsByTagName(be+":"+xe).length){var u=i.getElementsByTagName(be+":"+xe)[0];(l=i.createElement(be+":"+xe)).textContent=t,o.replaceChild(l,u)}else{var l;(l=i.createElement(be+":"+xe)).textContent=t,i.getElementsByTagName("rdf:Description")[0].appendChild(l)}if(0!=i.getElementsByTagName(be+":"+De).length){var m=i.getElementsByTagName(be+":"+De)[0];(d=i.createElement(be+":"+De)).textContent=n,o.replaceChild(d,m)}else{var d;(d=i.createElement(be+":"+De)).textContent=n,i.getElementsByTagName("rdf:Description")[0].appendChild(d)}if(0!=i.getElementsByTagName(be+":"+Ce).length){var p=i.getElementsByTagName(be+":"+Ce)[0];(h=i.createElement(be+":"+Ce)).textContent=r,o.replaceChild(h,p)}else{var h;(h=i.createElement(be+":"+Ce)).textContent=r,i.getElementsByTagName("rdf:Description")[0].appendChild(h)}const f=await(new ye.XMLSerializer).serializeToString(i);
// console.log(serialized);
await Be(f)}async function Le(){const e=await Me(),t=await(new ye.DOMParser).parseFromString(e,"text/xml");try{t.getElementsByTagName("rdf:Description")[0].removeAttribute("xmlns:"+be)}catch(e){console.log("Error "+e)}try{var n=t.getElementsByTagName(be+":"+Te);t.documentElement.removeChild(n)}catch(e){console.log("Error "+e+n)}try{var r=t.getElementsByTagName(be+":"+xe);t.documentElement.removeChild(r)}catch(e){console.log("Error "+e)}try{var a=t.getElementsByTagName(be+":"+De);t.documentElement.removeChild(a)}catch(e){console.log("Error "+e)}try{var i=t.getElementsByTagName(be+":"+Ce);t.documentElement.removeChild(i)}catch(e){console.log("Error "+e)}const o=await(new ye.XMLSerializer).serializeToString(t);await Be(o)}async function qe(){
// console.log("setUI start");
const e=await Me(),t=await(new ye.DOMParser).parseFromString(e,"text/xml");
// IF METAPROOF-TAG FOUND ###############################
if(0!=t.getElementsByTagName(be+":"+Te).length&&0!=t.getElementsByTagName(be+":"+xe).length&&0!=t.getElementsByTagName(be+":"+De).length){var n,r=t.getElementsByTagName(be+":"+Te)[0].childNodes[0].nodeValue,a=t.getElementsByTagName(be+":"+xe)[0].childNodes[0].nodeValue,i=t.getElementsByTagName(be+":"+De)[0].childNodes[0].nodeValue,o="";if(0!=t.getElementsByTagName(be+":"+Ce).length)o=t.getElementsByTagName(be+":"+Ce)[0].childNodes[0].nodeValue;for(Se.innerHTML=r+" – "+a,n=0;n<Ae.length;n++)// uncheck all other radios
Ae[n].checked=!1;try{document.querySelectorAll('sp-radio[data-proofProfil="'+r+'"][data-proofIntent="'+a+'"][data-proofTK="'+i+'"]')[0].checked=!0}catch(e){}var s=document.getElementsByClassName("sp-tab");// uncheck all tabs
...
}async function Pe(){var e,t;for(document.getElementById("proofinfo").innerHTML="no Softproof",e=0;e<Ae.length;e++)// uncheck all other radios
Ae[e].checked=!1;for(document.querySelectorAll("sp-radio")[0].checked=!0,t=0;t<Ie.length;t++)// check all noSoftproof-Radios
Ie[t].checked=!0,Ie[t].classList.add("checked");var n=document.getElementsByClassName("sp-tab");for(r=0;r<n.length;r++)n[r].classList.remove("active");var r;n=document.getElementsByClassName("sp-tab-page");for(r=0;r<n.length;r++)n[r].classList.remove("active")}
