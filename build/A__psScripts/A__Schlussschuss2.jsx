...
/*=================================================================================*/
function run(a){var o=app.activeDocument;0==o.saved&&dialog_saveWorkingfile()&&o.save();var r=!1;if(getMeta_3("isWoodwing"))r=Boolean(getMeta_3("isWoodwing"));if(getMeta_3("arbeitsdatei_RGB"))getMeta_3("arbeitsdatei_RGB");if(getMeta_3("woodwing_RGB"))var n=getMeta_3("woodwing_RGB");if(getMeta_3("woodwing_file"))var i=getMeta_3("woodwing_file");if(getMeta_3("woodwing_imageID"))getMeta_3("woodwing_imageID");if(getMeta_3("idDocName"))var s=getMeta_3("idDocName");try{hide("Layout"),debug&&alert("Layout versteckt")}catch(t){debug&&alert("Layout nicht gefunden: "+e)}
/*     $.writeln(isWoodwing);
        $.writeln(arbeitsdatei_RGB);
        $.writeln(woodwing_RGB);
        $.writeln(woodwing_file);
        $.writeln(woodwing_imageID);
        $.writeln(idDocName); */if(r){try{BridgeTalkMessage_openDocID(s,i,debug);// v2
}catch(e){debug&&alert("bt: "+e)}try{closeDoc(i);// v2
