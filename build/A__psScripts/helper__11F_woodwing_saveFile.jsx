...
// doc.suspendHistory("save Arbeitsdatei + Woodwing", "save_ArbeitWood_RGB()");
try{if(app.activeDocument.layerSets.getByName("Freisteller")&&hasLayerMask("Freisteller")){app.activeDocument.suspendHistory("getClosedSets","var start_closedSets = getClosedSets()"),undoSteps(1),historyState_deleteSteps(1);var startMaskVisibility=getMaskVisibility_bySelector("Freisteller");
...
setMaskVisibility_bySelector(startMaskVisibility,"Freisteller")}}catch(e){
// doc.suspendHistory("save Arbeitsdatei + Woodwing", "save_ArbeitWood_RGB()");
saveMultiformat(new File(woodwing_RGB),"jpg",t,RZ_qualityJPG,f,f);
// saveMultiformat(new File(arbeitsdatei_RGB), "psd", f, null, t, t);
// app.activeDocument.save();
}BridgeTalkMessage_checkInImage(idDocName,woodwing_imageID);for(var i=0;i<start_closedSets.length;i++)
...
// }
/* v2 */
function BridgeTalkMessage_openDocID(e,t){var a=new BridgeTalk;a.target="indesign",a.body=runID.toSource()+"('"+e+"','"+t+"');",a.onResult=function(e){},a.send(10)}
