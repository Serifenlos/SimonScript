...
smartObject_placeFile(new File("/Volumes/Archiv LOTUS/11Freunde_Auslagerung/TextilOnDemand/_Orga/Heather_Textur/heather_texture_v2.jpg")),nameLayer("heather_texture");
// =======================================================
var e=stringIDToTypeID("transform"),t=new ActionDescriptor,r=stringIDToTypeID("freeTransformCenterState"),a=stringIDToTypeID("quadCenterState"),n=stringIDToTypeID("QCSAverage");t.putEnumerated(r,a,n);var _=stringIDToTypeID("offset"),o=new ActionDescriptor,i=stringIDToTypeID("horizontal"),s=stringIDToTypeID("pixelsUnit");o.putUnitDouble(i,s,0);var l=stringIDToTypeID("vertical");s=stringIDToTypeID("pixelsUnit");o.putUnitDouble(l,s,0);_=stringIDToTypeID("offset");t.putObject(_,_,o),executeAction(e,t,DialogModes.ALL),hide("heather_texture"),layer_selectByColor("orange"),doc.close(SaveOptions.SAVECHANGES)}function correctRGB(){var e=[],t=Folder.selectDialog("Wähle den obersten Ordner aus. \nDie Unterordner werden auch mitverarbeitet.");if(null!=t)for(var r in e=function e(t,r){for(var a=Folder(t).getFiles(),n=0;n<a.length;n++){var _=a[n];_ instanceof File||(r.push(Folder(_)),e(_.toString(),r))}return r}(t,e),e.unshift(t),e)if(files=[],
// files = folders[a].getFiles(/.+\.(jpg|tif|psd|bmp|gif|png|)$/i);
files=e[r].getFiles(/.+\.(tif|psd)$/i),!(files.length<1))for(var a in files){var n=files[a],_=new File(n);try{
...
if(!array_contains(meta_getKeywords(n),"Frauen_Hoodie")){app.open(_);var o=app.activeDocument;layer_selectByColor("orange");
...
var c=i[2]-80;c>=0?c*=1:c=0,ToD_curves_shirt_modify(0,c,128,128,192,192,255,255),layer_selectByColor("orange"),o.close(SaveOptions.SAVECHANGES)}}catch(e){$.writeln("Error: "+e)}}}
...
var d=GetFileNameOnly(app.activeDocument.name).replace(/(__RGB)/g,"");$.writeln("PROCESS "+d);for(var m=0;m<e[l][2][p].length;m++)
// $.writeln(a + "-" + b + "-" + c + "-" + d + " - " + x[a][b][c][d] + " - Motiv");
if(e[l][2][p][m]&&(array_contains(meta_getKeywords(u),"vorne")&&m<=0||array_contains(meta_getKeywords(u),"hinten")&&m>=1)){for(g=0;g<e[l][1].length;g++){var b="";if(array_contains(meta_getKeywords(u),"vorne")&&m<=0)b="__vorne";else if(array_contains(meta_getKeywords(u),"hinten")&&m>=1)b="__hinten";o=e[l][0][0],a=e[l][2][p][m].replace("_vorne","").replace("_hinten",""),void 0!==(n=e[l][2][p][0])&&("blanko"==n&&(n=e[l][2][p][1]),_=n.replace(/(.*)(_\(.*\))/g,"$1").replace("_vorne","").replace("_hinten","").replace("_Hoodie","").replace("_Shirt","").replace("_schwarz","").replace("_grau","")),motivFarbe=n.replace("_vorne","").replace("_hinten",""),r=e[l][1][g][3],$.writeln(o+" -- "+a+" -- "+n+" -- "+motivFarbe+" -- "+_+" -- "+r),r=e[l][1][g][3];var v="~/Arbeit/11Freunde/TextilOnDemand/Output",y=new Folder(v+"/"+_+"/"+o+"__"+motivFarbe);
...
var w=o+"__"+r+b+"__"+a+"__("+d.replace(" ","_")+")",k=new File(y+"/"+w+".jpg");if($.writeln("export_file: "+k),k.exists)$.writeln("export_file existiet bereits");else{layer_selectByColor("orange"),smartObject_placeFile(new File("/Volumes/Archiv LOTUS/11Freunde_Auslagerung/TextilOnDemand/mood_Motive/"+e[l][2][p][m]+".psd"));for(var D=0;D<layer_getIDXbyString("Farbe").length;D++)gotoLayer(layer_getIDXbyString("Farbe")[D]),layer_solidColorHSB_change(e[l][1][g][0],e[l][1][g][1],e[l][1][g][2]);gotoLayer("heather_texture"),0==e[l][1][g][4]?hide():makeVisible(),gotoLayer(d+"__grau");
// ToD_curves_shirt_modify(0, x[a][1][g][2] * 0.62, 128, 128, 192, 192, 255, 255);
var F=e[l][1][g][2]-80;F>=0?F*=1:F=0,ToD_curves_shirt_modify(0,F,128,128,192,192,255,255),SaveForWeb("JPEG",y,w,f,f,f,t,t,255,255,255,"Meta_all_noKameraInfo",66,t,t,0),$.writeln("saved "+decodeURIComponent(y)+"/"+w);try{
...
var A=new Folder(v+"_Web/"+_+"/"+o+"__"+motivFarbe);A.exists||A.create(),SaveForWeb("JPEG",A,w,50,f,f,t,t,255,255,255,"Meta_all_noKameraInfo",66,t,t,0),$.writeln("saved WEB "+decodeURIComponent(A)+"/"+w)}catch(D){$.writeln("Error: "+D)}}}emptyProtocoll()}}}catch(D){$.writeln("Error_1: "+D)}}try{0!=documents.length&&app.activeDocument.close(SaveOptions.DONOTSAVECHANGES)}catch(D){alert("error2 "+D)}}}catch(D){alert("error "+D)}}
// $.writeln("Ende: " + time_stop(start))
var S=((new Date).getTime()-start)/1e3,O="Done ("+Number(S).toFixed(3)+" secs).";$.writeln(O)}}function createRGB(){var e=[],r=Folder.selectDialog("Wähle den obersten Ordner aus. \nDie Unterordner werden auch mitverarbeitet.");if(null!=r)for(var a in(e=FindAllFolders(r,e)).unshift(r),e)if(files=[],files=e[a].getFiles(/.+\.dng$/i),!(files.length<1))for(var n in files){var _=files[n],o=new File(_);try{var i=decodeURIComponent(GetFileNameOnly(o.name)),s=o.path,l=new File(s+"/"+i+"__mood.jpg"),c=new File(s+"/"+i+"__grau.jpg"),u=new File("/Volumes/Archiv LOTUS/11Freunde_Auslagerung/TextilOnDemand/_Orga/Heather_Textur/heather_texture.jpg"),h=new File("/Volumes/Archiv LOTUS/11Freunde_Auslagerung/TextilOnDemand/_Orga/Heather_Textur/heather_texture_breit.jpg"),p=new File("/Volumes/Archiv LOTUS/11Freunde_Auslagerung/TextilOnDemand/mood_Motive/11-Kasten_orange.psd"),d=new File(s+"/"+i+"__map.psd"),g=new Folder(s.replace(/(DNG\/Shooting%20Sortierung)/g,"RGB"));g.exists||g.create();var m=new File(g+"/"+i+"__RGB.psd");
...
layer_getMaskBounds("Textil"),gotoLayer("heather_texture");var v=app.preferences.rulerUnits;app.preferences.rulerUnits=Units.PIXELS,ToD_transform(parseFloat(MaskBound_x),parseFloat(MaskBound_y),parseFloat(MaskBound_w),parseFloat(MaskBound_h)),app.preferences.rulerUnits=v,hide(),createGroup_ToD("Maske"),layer_createMask(),ToD_createLayer("Motiv",100,layer_getIDXbyString("heather_texture")+1),smartObject(),smartObject_placeFile(p),layer_setColorLabel("orange"),ToD_transform_percent(0,1800,45,45),
// setLayerOpacity(86);
...
// =======================================================
function doc_create(e,t,r,a,n,_,o,i){var s=new ActionDescriptor,l=new ActionDescriptor,c=new ActionList;//autoPromoteBackgroundLayer
if(l.putString(s2t("name"),e),l.putBoolean(s2t("artboard"),!1),//artboard
l.putBoolean(s2t("autoPromoteBackgroundLayer"),!1),"RGB"==t)var u="RGBColorMode";if("CMYK"==t)u="CMYKColorMode";if("grau"==t)u="grayscaleMode";if("bitmap"==t)u="bitmapMode";if("Lab"==t)u="labColorMode";var h=2.54;if("px"==a)var p=72*n/o,d=72*_/o;if("mm"==a)p=n/h*72/10,d=_/h*72/10;if("cm"==a)p=n/h*72,d=_/h*72;if("inch"==a)p=72*n,d=72*_;l.putClass(s2t("mode"),s2t(u)),l.putUnitDouble(s2t("width"),s2t("distanceUnit"),p),l.putUnitDouble(s2t("height"),s2t("distanceUnit"),d),l.putUnitDouble(s2t("resolution"),s2t("densityUnit"),o),l.putDouble(s2t("pixelScaleFactor"),1),//pixelScaleFactor
...
// =======================================================
function layer_duplicate(e,t,r,a,n,_){var o=new ActionDescriptor,i=new ActionDescriptor;i.putString(s2t("name"),e),i.putEnumerated(s2t("mode"),s2t("blendMode"),s2t(r)),i.putUnitDouble(s2t("opacity"),s2t("percentUnit"),t),i.putBoolean(s2t("group"),n),i.putEnumerated(s2t("color"),s2t("color"),s2t(a)),o.putObject(s2t("new"),s2t("layer"),i),o.putEnumerated(s2t("using"),s2t("areaSelector"),s2t("selectionEnum")),o.putBoolean(s2t("copy"),_),executeAction(s2t("make"),o,DialogModes.NO)}
// =======================================================
...
// =======================================================
function kanalberechnung_ToD(e){var t=new ActionDescriptor,r=new ActionDescriptor,a=new ActionReference,n=new ActionReference,_=new ActionReference;a.putProperty(s2t("channel"),s2t("selection")),t.putReference(s2t("null"),a),n.putEnumerated(s2t("channel"),s2t("channel"),s2t("transparencyEnum")),n.putEnumerated(s2t("layer"),s2t("ordinal"),s2t("merged")),n.putName(s2t("document"),e),r.putReference(s2t("to"),n),_.putEnumerated(s2t("channel"),s2t("channel"),s2t("transparencyEnum")),_.putEnumerated(s2t("layer"),s2t("ordinal"),s2t("merged")),_.putName(s2t("document"),e),r.putReference(s2t("source2"),_),t.putObject(s2t("to"),s2t("calculation"),r),executeAction(s2t("set"),t,DialogModes.NO)}
// =======================================================
...
// }
// =======================================================
function smartBrushWorkspace(e,t,r,a,n,_,o,i,s,l,c){var u=new ActionDescriptor;u.putEnumerated(s2t("presetKind"),s2t("presetKindType"),s2t("presetKindCustom")),u.putInteger(s2t("smartBrushRadius"),e),u.putInteger(s2t("smartBrushSmooth"),t),u.putUnitDouble(s2t("smartBrushFeather"),s2t("pixelsUnit"),r),u.putUnitDouble(s2t("smartBrushContrast"),s2t("percentUnit"),a),u.putUnitDouble(s2t("smartBrushShiftEdge"),s2t("percentUnit"),n),u.putBoolean(s2t("sampleAllLayers"),_),u.putBoolean(s2t("smartBrushUseSmartRadius"),o),u.putBoolean(s2t("smartBrushUseDeepMatte"),i),u.putBoolean(s2t("autoTrimap"),s),u.putBoolean(s2t("smartBrushDecontaminate"),l),u.putUnitDouble(s2t("smartBrushDeconAmount"),s2t("percentUnit"),c),u.putEnumerated(s2t("refineEdgeOutput"),s2t("refineEdgeOutput"),s2t("selectionOutputToUserMask")),executeAction(s2t("smartBrushWorkspace"),u,DialogModes.NO)}
// =======================================================
function ToD_farbcheck_selection(e,t,r,a,n){var _=new ActionDescriptor,o=new ActionDescriptor,i=new ActionReference;i.putProperty(s2t("channel"),s2t("selection")),_.putReference(s2t("null"),i),o.putUnitDouble(s2t("top"),s2t("pixelsUnit"),e),o.putUnitDouble(s2t("left"),s2t("pixelsUnit"),t),o.putUnitDouble(s2t("bottom"),s2t("pixelsUnit"),r),o.putUnitDouble(s2t("right"),s2t("pixelsUnit"),a),_.putObject(s2t("to"),s2t("ellipse"),o),_.putBoolean(s2t("antiAlias"),n),executeAction(s2t("set"),_,DialogModes.NO)}
// =======================================================
...
// =======================================================
function ToD_transform(e,t,r,a){var n=new ActionDescriptor,_=new ActionDescriptor;n.putEnumerated(s2t("freeTransformCenterState"),s2t("quadCenterState"),s2t("QCSCorner0")),_.putUnitDouble(s2t("horizontal"),s2t("pixelsUnit"),e),_.putUnitDouble(s2t("vertical"),s2t("pixelsUnit"),t),n.putObject(s2t("offset"),s2t("offset"),_);var o=parseFloat(r/app.activeDocument.width*100),i=parseFloat(a/app.activeDocument.height*100);$.writeln("width2 "+o),$.writeln("height2 "+i),n.putUnitDouble(s2t("width"),s2t("percentUnit"),o),n.putUnitDouble(s2t("height"),s2t("percentUnit"),i),executeAction(s2t("transform"),n,DialogModes.NO)}
// =======================================================
...
var e=new File("/Volumes/Archiv LOTUS/11Freunde_Auslagerung/TextilOnDemand/mood_Motive/_motive_MAIN.psd");app.open(e);for(var r=1;layer_checkExistence(r);){selectLayers("selectAllLayers"),hide(),makeVisByIndex(r,t);var a="/Volumes/Archiv LOTUS/11Freunde_Auslagerung/TextilOnDemand/mood_Motive/export/"+layer_getName(r)+".psd";savePSD_v2(new File(a),t,t,t,f),r++}app.documents.getByName("_motive_MAIN.psd").close(SaveOptions.DONOTSAVECHANGES)}
// =======================================================
function ToD_createLayer(e,t,r){var a=new ActionDescriptor,n=new ActionDescriptor,_=new ActionReference;_.putClass(s2t("layer")),a.putReference(s2t("null"),_),n.putString(s2t("name"),e),n.putUnitDouble(s2t("opacity"),s2t("percentUnit"),t),n.putEnumerated(s2t("color"),s2t("color"),s2t("grain")),a.putObject(s2t("using"),s2t("layer"),n),a.putInteger(s2t("layerID"),r),executeAction(s2t("make"),a,DialogModes.NO)}
// =======================================================
function ToD_transform_percent(e,t,r,a){var n=new ActionDescriptor,_=new ActionDescriptor;n.putEnumerated(s2t("freeTransformCenterState"),s2t("quadCenterState"),s2t("QCSAverage")),_.putUnitDouble(s2t("horizontal"),s2t("pixelsUnit"),e),_.putUnitDouble(s2t("vertical"),s2t("pixelsUnit"),t),n.putObject(s2t("offset"),s2t("offset"),_),n.putUnitDouble(s2t("width"),s2t("percentUnit"),r),n.putUnitDouble(s2t("height"),s2t("percentUnit"),a),executeAction(s2t("transform"),n,DialogModes.NO)}function filter_displace(e,t,r,a){var n=new ActionDescriptor;n.putInteger(s2t("horizontalScale"),e),n.putInteger(s2t("verticalScale"),t),n.putEnumerated(s2t("displacementMap"),s2t("displacementMap"),s2t("stretchToFit")),n.putEnumerated(s2t("undefinedArea"),s2t("undefinedArea"),s2t("repeatEdgePixels")),n.putPath(s2t("displaceFile"),r),n.putBoolean(c2t("EmbF"),a),executeAction(s2t("displace"),n,DialogModes.NO)}function layer_setColorLabel(e){var t=new ActionDescriptor,r=new ActionDescriptor,a=new ActionReference;a.putEnumerated(s2t("layer"),s2t("ordinal"),s2t("targetEnum")),t.putReference(s2t("null"),a),r.putEnumerated(s2t("color"),s2t("color"),s2t(e)),t.putObject(s2t("to"),s2t("layer"),r),executeAction(s2t("set"),t,DialogModes.NO)}
// =======================================================
...
function ToD_curves_schatten(e,t,r,a){var n=new ActionDescriptor,_=new ActionDescriptor,o=new ActionDescriptor,i=new ActionDescriptor,s=new ActionList,l=new ActionList,c=new ActionReference;n.putEnumerated(s2t("presetKind"),s2t("presetKindType"),s2t("presetKindCustom")),c.putEnumerated(s2t("channel"),s2t("channel"),s2t("composite")),_.putReference(s2t("channel"),c),o.putDouble(s2t("horizontal"),e),o.putDouble(s2t("vertical"),t),l.putObject(s2t("paint"),o),i.putDouble(s2t("horizontal"),r),i.putDouble(s2t("vertical"),a),l.putObject(s2t("paint"),i),_.putList(s2t("curve"),l),s.putObject(s2t("curvesAdjustment"),_),n.putList(s2t("adjustment"),s),executeAction(s2t("curves"),n,DialogModes.NO)}
// =======================================================
function ToD_filterFX_setting(e,t,r){var a=new ActionDescriptor,n=new ActionDescriptor,_=new ActionDescriptor,o=new ActionReference;o.putIndex(s2t("filterFX"),e),o.putEnumerated(s2t("layer"),s2t("ordinal"),s2t("targetEnum")),a.putReference(s2t("null"),o),_.putUnitDouble(s2t("opacity"),s2t("percentUnit"),t),_.putEnumerated(s2t("mode"),s2t("blendMode"),s2t(r)),n.putObject(s2t("blendOptions"),s2t("blendOptions"),_),a.putObject(s2t("filterFX"),s2t("filterFX"),n),executeAction(s2t("set"),a,DialogModes.NO)}
// ToD_curves_shirt_create(0, 0, 128, 128, 192, 192, 255, 255);
// ToD_curves_shirt_modify(0, 0, 128, 128, 192, 192, 255, 255);
function ToD_curves_shirt_create(e,t,r,a,n,_,o,i){var s=new ActionDescriptor,l=new ActionDescriptor,c=new ActionDescriptor,u=new ActionDescriptor,h=new ActionDescriptor,p=new ActionDescriptor,d=new ActionList,g=new ActionList,m=new ActionReference;s.putEnumerated(s2t("presetKind"),s2t("presetKindType"),s2t("presetKindCustom")),m.putEnumerated(s2t("channel"),s2t("channel"),s2t("composite")),l.putReference(s2t("channel"),m),c.putDouble(s2t("horizontal"),e),c.putDouble(s2t("vertical"),t),g.putObject(s2t("paint"),c),u.putDouble(s2t("horizontal"),r),u.putDouble(s2t("vertical"),a),g.putObject(s2t("paint"),u),h.putDouble(s2t("horizontal"),n),h.putDouble(s2t("vertical"),_),g.putObject(s2t("paint"),h),p.putDouble(s2t("horizontal"),o),p.putDouble(s2t("vertical"),i),g.putObject(s2t("paint"),p),l.putList(s2t("curve"),g),d.putObject(s2t("curvesAdjustment"),l),s.putList(s2t("adjustment"),d),executeAction(s2t("curves"),s,DialogModes.NO)}function ToD_curves_shirt_modify(e,t,r,a,n,_,o,i){var s=new ActionDescriptor,l=new ActionDescriptor,c=new ActionDescriptor,u=new ActionDescriptor,h=new ActionDescriptor,p=new ActionDescriptor,d=new ActionDescriptor,g=new ActionDescriptor,m=new ActionList,b=new ActionList,v=new ActionReference,y=new ActionReference;v.putIndex(s2t("filterFX"),2),v.putEnumerated(s2t("layer"),s2t("ordinal"),s2t("targetEnum")),s.putReference(s2t("null"),v),c.putEnumerated(s2t("presetKind"),s2t("presetKindType"),s2t("presetKindCustom")),y.putEnumerated(s2t("channel"),s2t("channel"),s2t("composite")),u.putReference(s2t("channel"),y),h.putDouble(s2t("horizontal"),e),h.putDouble(s2t("vertical"),t),b.putObject(s2t("paint"),h),p.putDouble(s2t("horizontal"),r),p.putDouble(s2t("vertical"),a),b.putObject(s2t("paint"),p),d.putDouble(s2t("horizontal"),n),d.putDouble(s2t("vertical"),_),b.putObject(s2t("paint"),d),g.putDouble(s2t("horizontal"),o),g.putDouble(s2t("vertical"),i),b.putObject(s2t("paint"),g),u.putList(s2t("curve"),b),m.putObject(s2t("curvesAdjustment"),u),c.putList(s2t("adjustment"),m),l.putObject(s2t("filter"),s2t("curves"),c),s.putObject(s2t("filterFX"),s2t("filterFX"),l),executeAction(s2t("set"),s,DialogModes.NO)}
...
// select workpath
var _=new ActionDescriptor,o=new ActionReference;o.putProperty(s2t("path"),s2t("workPath")),_.putReference(s2t("null"),o),executeAction(s2t("select"),_,DialogModes.NO);
// rename path
var i=new ActionDescriptor,s=new ActionReference,l=new ActionReference;s.putClass(s2t("path")),i.putReference(s2t("null"),s),l.putProperty(s2t("path"),s2t("workPath")),i.putReference(s2t("from"),l),i.putString(s2t("name"),t),executeAction(s2t("make"),i,DialogModes.NO)}run(collection=[[["T_Shirt"],[white],[motiv_11F_ZK_TShirt1]]]);