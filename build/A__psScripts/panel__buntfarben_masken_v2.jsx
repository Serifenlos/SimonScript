...
layer_checkExistence("[helper] Farbmaske")?doc.suspendHistory("[helper] Farbmaske Selection","mask_setSaturation_singleColors_create('[helper] Farbmaske')"):doc.suspendHistory("[helper] Farbmaske preview","mask_setSaturation_singleColors_create('[helper] Farbmaske', 'v2')");