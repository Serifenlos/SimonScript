...
/**************/
// Randomize array
function shuffle(e){const o=e.length;for(var r=0;r<o;r++){var n=Math.floor((e.length-r)*Math.random()),a=e.splice(n,1);e.push(a)}return e}
...
function layer_findChild(e,o){for(var r=e.layers.length-1;r>=0;r--){var n=e.layers[r];if("ArtLayer"==n.typename&&n.name==o){thisLayerIDX=n.itemIndex;break}}return thisLayerIDX}
/** **/
/** Loop through LayerSets **/
// var theLayers = layer_loopChilden(doc.activeLayer, []);
// $.writeln(theLayers);
function layer_loopChilden(e,o,r,n,a,l,d,m){
...
// };
// for (var m = theNumber; m >= 0; m--) {
for(var i=0;i<1;i++){$.writeln("processRahmen: "+[l[i]]);var s=e.layers[l[i]];if("LayerSet"==s.typename){thisLayerIDX=s.itemIndex,makeVisByIndex(thisLayerIDX,!0),$.writeln("poster: "+m),1==[l[i]]&&(layerFX__toggle(d,"innerShadow",1,"hide"),m&&(layerFX__toggle(getParentIDXfor(getParentIDXfor(thisLayerIDX)),"dropShadow",1,"hide"),layerFX__toggle(getParentIDXfor(getParentIDXfor(thisLayerIDX)),"dropShadow",2,"hide"),layerFX__toggle(getParentIDXfor(getParentIDXfor(thisLayerIDX)),"dropShadow",3,"show"))),SaveForWeb("JPEG",o,r+"___"+n+"-"+s.name,a,f,f,t,t,255,255,255,"Meta_no",66,t,t,0),
...
/** **/
/** das Herz **/function processMood(e,o,r,n,a,t,l,d,m){$.writeln("processMood: "+t);var i=new File(moodsFolder+t+".psd");app.activeDocument=app.documents.getByName(decodeURI(i.name));var s=bw_scale(l);if(""!=o)var h=e+"_"+o;else h=e;gotoLayer(h),makeVisible(),gotoLayer(layer_findChild(app.activeDocument.activeLayer,"Motiv"));var _=getActiveLayerIndex();SmartOject_placeItem(r),gotoLayer(h),layer_loopChilden(app.activeDocument.activeLayer,n,a,t,s,d,_,m),resetImage()}
...
/*************************/
/**************/
/****/Array.prototype.indexOf=function(e){for(var o=0,r=this.length;o<r;o++)if(this[o]===e)return o;return-1};var run_all=!0,run_3x2=!1,run_4x3=!1,run_1x1=!1,run_A4=!1,run_pano=!1;const outputWidth=2400,moodsFolder="/Volumes/Archiv LOTUS/11Freunde_Auslagerung/Bilderwelt_Moods/MAIN/",outputFolder=new Folder("/Users/adrians/Arbeit/11Freunde/Bilderwelt/_OUTPUT/Moods");
...
outputFolder.exists||outputFolder.create();const moods=["mood01","mood02","mood03","mood04","mood05","mood06","mood07","mood08","mood09","mood10","mood11","mood12","mood13"],Bilderwelt_Anzahl_Mood=5,Poster_Anzahl_Mood=3,Bilderwelt_Anzahl_Rahmen=[1,1,1,2],Poster_Anzahl_Rahmen=[1,1,0,1],fileList_start=1,fileList_end=330;
/*************************/
/**************/
/****/
...
// var fileList = inputFolder.getFiles(/^[^.].*(__45x30|__40x30|__40x40|__100x40|__A4).*\.(jpg|tif|psd|bmp|gif|png|)$/im);
// var fileList = inputFolder.getFiles(/^([^\.]).*(__45x30|__40x30|__40x40|__100x40|__A4).*\.(jpg|tif|psd|bmp|gif|png|)$/im);
var e=inputFolder.getFiles(/.+(__45x30|__40x30|__40x40|__100x40|__A4).*\.(?:gif|jpe?g|[ew]mf|eps|tiff?|psd|pdf|bmp|png)$/i),o=[],r=0
/* Clean the list of hidden files */;r<e.length;r++)e[r].hidden||o.push(e[r]);e=o;$.writeln("fileList.length: "+e.length)
/* write list of all files */;for(var n=0;n<e.length;n++)bw_log(decodeURI(e[n].name));if(bw_log("---\nfileList.length: "+e.length+"\n"),330>e.length)var a=e.length;else a=330;for(var t=0;t<moods.length;t++){var l=new File(moodsFolder+moods[t]+".psd");app.open(l)}outputFolder.exists||outputFolder.create();
...
// emptyProtocoll();
// closeAll();
prefReset(),time_stop(start)}function randomNumber(e,o,r,n,a){for(var t=0;t<n;){var l=Math.floor(Math.random()*(o-e+1))+e;-1!=r.indexOf(l)?randomNumber(e,o,r):(r.push(l),a&&r.sort((function(e,o){return e-o})),t++)}return r}
// $.writeln(randomNumber(1, 13, [], 2));
// $.writeln("5: "+array.indexOf(5))
// $.writeln("4: "+array.indexOf(4))
function bw_log(e){var o="/Users/adrians/Arbeit/11Freunde/Bilderwelt_Moods/Bilderwelt_Moods.log",r=File(o);r.exists||(r=new File(o));var n=File(o);n.open("a",void 0,void 0),n.encoding="UTF8",""!==n&&(
// log_file.writeln("-----------------------");
n.writeln(e),
// log_file.writeln("");
n.close())}
...
function layerFX__toggle(e,o,r,n){var a=new ActionDescriptor,t=new ActionList,l=new ActionReference;l.putIndex(s2t(o),r),l.putIndex(sTID("layer"),e),
// r.putName(s2t("layer"), "Motiv");  // select by Name
t.putReference(l),a.putList(s2t("null"),t),executeAction(s2t(n),a,DialogModes.NO)}
// =======================================================
