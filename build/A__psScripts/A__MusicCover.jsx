...
// HG reduzieren=======================================================
var idFltI=charIDToTypeID("FltI");function setSaveName2(e,r,d){var t=new Folder(e);t.exists||t.create();for(var c=t+"/"+(o=r)+"."+d,i=File(c);i.exists;){var o;c=t+"/"+(o=o+"+")+"."+d,i=File(c)}return o}executeAction(idFltI,void 0,DialogModes.NO);var saveFolder="~/Arbeit/__temp/MusikCover";SaveForWeb("JPEG",saveFolder,setSaveName2(saveFolder,"cover","jpg"),f,f,f,t,t,255,255,255,"Meta_no",66,t,t,0);