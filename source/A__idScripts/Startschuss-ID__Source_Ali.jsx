...
<javascriptresource>
<name>[ss] Startschuss ID für Ali</name>
...
var mainFolder = "/Users/macbookali/Desktop/11Freunde/";
var subFolder = "#234";
...
function runPS(myImagePath, myNewPath, hScale, vScale, ZielAufloesung, minAufloesung, hPPI, option_convert_8bit) {
    ...
    /* DEBUGGING ****************************/
    function time_start(){start=(new Date).getTime()}function time_stop(e){var t=(new Date).getTime(),n="Done ("+Number((t-e)/1e3).toFixed(3)+" secs).";alert(n)}function logger(e){debug&&time_start();var t="~/Desktop/SimonScript.log",n=File(t);n.exists||(n=new File(t));var o=new Date,r=("0"+o.getDate()).slice(-2)+"."+("0"+(o.getMonth()+1)).slice(-2)+"."+o.getFullYear()+" - "+(("0"+o.getHours()).slice(-2)+":"+("0"+o.getMinutes()).slice(-2)+":"+("0"+o.getSeconds()).slice(-2)),s=File(t);s.open("a",void 0,void 0),""!==s&&(s.writeln("-----------------------"),s.writeln(r),s.writeln("Doc: '"+doc.name+"'"),s.writeln("Function: '"+e+"'"),s.writeln(""),s.close()),debug&&time_stop(start)}
    /* LAYER *********************************/
    /* createLayer("AutoTonwert", "levels", "normal", "gray", 80, "black", f,f) */function createLayer(e,t,n,o,r,s,i,c){try{var a=new ActionDescriptor,l=new ActionReference;l.putClass(sTID("adjustmentLayer")),a.putReference(sTID("null"),l);var D=new ActionDescriptor;if(D.putString(sTID("name"),e),D.putUnitDouble(sTID("opacity"),sTID("percentUnit"),r),D.putEnumerated(sTID("mode"),sTID("blendMode"),sTID(n)),D.putEnumerated(sTID("color"),sTID("color"),sTID(o)),D.putBoolean(sTID("group"),i),"levels"==t&&c){var u=new ActionDescriptor;u.putEnumerated(sTID("presetKind"),sTID("presetKindType"),sTID("presetKindDefault"));var p=new ActionList,I=new ActionDescriptor,T=new ActionReference;T.putEnumerated(sTID("channel"),sTID("channel"),sTID("composite")),I.putReference(sTID("channel"),T),I.putBoolean(sTID("auto"),!0),p.putObject(sTID("levelsAdjustment"),I),u.putList(sTID("adjustment"),p),D.putObject(sTID("type"),sTID(t),u)}else D.putClass(sTID("type"),sTID(t));if(a.putObject(sTID("using"),sTID("adjustmentLayer"),D),executeAction(sTID("make"),a,DialogModes.NO),"invert"==s)return void executeAction(sTID("invert"),void 0,DialogModes.NO);if("none"==s)return void deleteMask();if("black"==s||"white"==s||"gray"==s)return void fill(s,"normal",100)}catch(e){logger(arguments.callee.name)}}
    /* createColorLayer("Weiss", "normal", "gray", 100, "none", 255, 255, 255); */function createColorLayer(e,t,n,o,r,s,i,c){try{var a=new ActionDescriptor,l=new ActionReference;l.putClass(sTID("contentLayer")),a.putReference(sTID("null"),l);var D=new ActionDescriptor;D.putString(sTID("name"),e),D.putUnitDouble(sTID("opacity"),sTID("percentUnit"),o),D.putEnumerated(sTID("mode"),sTID("blendMode"),sTID(t)),D.putEnumerated(sTID("color"),sTID("color"),sTID(n));var u=new ActionDescriptor,p=new ActionDescriptor;if(p.putDouble(sTID("red"),s),p.putDouble(sTID("green"),i),p.putDouble(sTID("blue"),c),u.putObject(sTID("color"),sTID("RGBColor"),p),D.putObject(sTID("type"),sTID("solidColorLayer"),u),a.putObject(sTID("using"),sTID("contentLayer"),D),executeAction(sTID("make"),a,DialogModes.NO),gotoMask(),"invert"==r)return void executeAction(sTID("invert"),void 0,DialogModes.NO);if("none"==r)return void deleteMask();if("black"==r||"white"==r||"gray"==r)return void fill(r,"normal",100)}catch(e){logger(arguments.callee.name)}}
    ...
    /* moveLayer("Weiss", "Original", "down");*/function moveLayer(e,t,n){gotoLayer(e);var o=app.activeDocument.activeLayer;gotoLayer(t);var r=app.activeDocument.activeLayer;if("up"==n)var s=ElementPlacement.PLACEBEFORE;else if("down"==n)s=ElementPlacement.PLACEAFTER;o.move(r,s)}
    /* up   down     top   bottom */
    /* next previous front back */function moveLayer3(e,t){"up"==e&&(e="next"),"down"==e&&(e="previous"),"top"==e&&(e="front"),"bottom"==e&&(e="back");for(var n=0;n<t;n++){var o=new ActionDescriptor,r=new ActionReference,s=new ActionReference;r.putEnumerated(sTID("layer"),sTID("ordinal"),sTID("targetEnum")),o.putReference(sTID("null"),r),s.putEnumerated(sTID("layer"),sTID("ordinal"),sTID(e)),o.putReference(sTID("to"),s),executeAction(sTID("move"),o,DialogModes.NO)}}function deleteMask(){try{var e=new ActionDescriptor,t=new ActionReference;t.putEnumerated(sTID("channel"),sTID("channel"),sTID("mask")),e.putReference(sTID("null"),t),executeAction(sTID("delete"),e,DialogModes.NO)}catch(e){logger(arguments.callee.name)}}function createGroup(e,t,n,o,r){try{var s=new ActionDescriptor,i=new ActionReference;if(i.putClass(sTID("layerSection")),s.putReference(sTID("null"),i),r){var c=new ActionReference;c.putEnumerated(sTID("layer"),sTID("ordinal"),sTID("targetEnum")),s.putReference(sTID("from"),c)}var a=new ActionDescriptor;a.putString(sTID("name"),e),a.putUnitDouble(sTID("opacity"),sTID("percentUnit"),o),a.putEnumerated(sTID("color"),sTID("color"),sTID(n)),a.putEnumerated(sTID("mode"),sTID("blendMode"),sTID(t)),s.putObject(sTID("using"),sTID("layerSection"),a),s.putInteger(sTID("layerSectionStart"),351),s.putInteger(sTID("layerSectionEnd"),352),s.putString(sTID("name"),"Gruppe 3"),executeAction(sTID("make"),s,DialogModes.NO)}catch(e){logger(arguments.callee.name)}}
    /*
    fill("black", "normal", 100)
    fill("color", "multiply", 50, 240,50,50)
    */function fill(e,t,n,o,r,s){try{var i=new ActionDescriptor;if(i.putEnumerated(sTID("using"),sTID("fillContents"),sTID(e)),"color"==e){var c=new ActionDescriptor;c.putUnitDouble(sTID("hue"),sTID("angleUnit"),o),c.putDouble(sTID("saturation"),r),c.putDouble(sTID("brightness"),s),i.putObject(sTID("color"),sTID("HSBColorClass"),c)}i.putUnitDouble(sTID("opacity"),sTID("percentUnit"),n),i.putEnumerated(sTID("mode"),sTID("blendMode"),sTID(t)),executeAction(sTID("fill"),i,DialogModes.NO)}catch(e){logger(arguments.callee.name)}}function smartObject(){try{executeAction(stringIDToTypeID("newPlacedLayer"),void 0,DialogModes.NO)}catch(e){logger(arguments.callee.name)}}function rasterSmartObject(){try{var e=new ActionDescriptor,t=new ActionReference;t.putEnumerated(sTID("layer"),sTID("ordinal"),sTID("targetEnum")),e.putReference(sTID("null"),t),executeAction(sTID("rasterizeLayer"),e,DialogModes.NO)}catch(e){logger(arguments.callee.name)}}function nameLayer(e){try{doc.activeLayer.name=e}catch(e){logger(arguments.callee.name)}}function dublicate(e){var t=new ActionDescriptor,n=new ActionReference;n.putEnumerated(sTID("layer"),sTID("ordinal"),sTID("targetEnum")),t.putReference(sTID("null"),n),t.putString(sTID("name"),e),t.putInteger(sTID("version"),5),executeAction(sTID("duplicate"),t,DialogModes.NO)}
    ...
    /* setMegaPixel(8) */function setMegaPixel(e){prefSave(),prefSet(DialogModes.NO,Units.PIXELS);var t=doc.width,n=doc.height,o=t*n,r=1e6*e,s=r/o;if(r<o)if(t>=n){var i=t*Math.sqrt(s);doc.resizeImage(i,void 0,void 0,ResampleMethod.PRESERVEDETAILS,0)}else{var c=Math.round(n*Math.sqrt(s));doc.resizeImage(void 0,c,void 0,ResampleMethod.PRESERVEDETAILS,0)}return prefReset(),""}
    ...
    /* WEB-Output ****************************/function GetFileNameOnly(e){var t=e.lastIndexOf(".");return-1==t?e:e.substr(0,t)}function replace_RGB_to_RZ(){if(!(e=GetFileNameOnly(doc.name).replace(/(__RGB.*)$/g,Suffix_RZ).replace(/(__RZ.*)$/g,Suffix_RZ)).match(/__WEB/g))var e=e+Suffix_RZ;return e}function saveRZ(e,t,n){(e=new Folder(e)).exists||e.create();for(var o=e+"/"+t+(s=replace_RGB_to_RZ())+"."+n,r=File(o);r.exists;){var s;o=e+"/"+t+(s=s+"+")+"."+n,r=File(o)}if("tif"==n)(i=new TiffSaveOptions).alphaChannels=!0,i.byteOrder=ByteOrder.IBM,i.embedColorProfile=!0,i.imageCompression=TIFFEncoding.TIFFLZW,i.layers=!0,i.spotColors=!1,i.transparency=!0,i.annotations=!1;else if("jpg"==n){(i=new JPEGSaveOptions).embedColorProfile=!0,i.formatOptions=FormatOptions.STANDARDBASELINE,i.matte=MatteType.WHITE,i.quality=11}else if("psd"==n){var i;(i=new PhotoshopSaveOptions).alphaChannels=!1,i.annotations=!1,i.embedColorProfile=!0,i.layers=!0,i.spotColors=!1}doc.saveAs(new File(o),i,!1,Extension.LOWERCASE)}
    /*=================================================================================*/function selectAllLayers(){var e=new ActionDescriptor,t=new ActionReference;t.putEnumerated(sTID("layer"),sTID("ordinal"),sTID("targetEnum")),e.putReference(sTID("null"),t),executeAction(sTID("selectAllLayers"),e,DialogModes.NO)}function mergeLayers(){var e=new ActionDescriptor;executeAction(sTID("mergeLayersNew"),e,DialogModes.NO)}function blendif(e,t,n,o){var r=new ActionDescriptor,s=new ActionReference;s.putEnumerated(sTID("layer"),sTID("ordinal"),sTID("targetEnum")),r.putReference(sTID("null"),s);var i=new ActionDescriptor,c=new ActionList,a=new ActionDescriptor,l=new ActionReference;l.putEnumerated(sTID("channel"),sTID("channel"),sTID("gray")),a.putReference(sTID("channel"),l),a.putInteger(sTID("srcBlackMin"),0),a.putInteger(sTID("srcBlackMax"),0),a.putInteger(sTID("srcWhiteMin"),255),a.putInteger(sTID("srcWhiteMax"),255),a.putInteger(sTID("destBlackMin"),e),a.putInteger(sTID("destBlackMax"),t),a.putInteger(sTID("destWhiteMin"),n),a.putInteger(sTID("desaturate"),o),c.putObject(sTID("blendRange"),a),i.putList(sTID("blendRange"),c);var D=new ActionDescriptor;D.putUnitDouble(sTID("scale"),sTID("percentUnit"),100),i.putObject(sTID("layerEffects"),sTID("layerEffects"),D),r.putObject(sTID("to"),sTID("layer"),i),executeAction(sTID("set"),r,DialogModes.NO)}app.documents.length>0&&(doc=app.activeDocument,docs=app.documents,f=!1,t=!0,debug=!1);
    /*
        <javascriptresource>
          <name>BCM> Utils...</name>
